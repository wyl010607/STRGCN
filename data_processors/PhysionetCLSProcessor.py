...
class PhysionetCLSProcessor(AbstractDataProcessor):
    """
    PhysionetCLSProcessor classification processor (PTdict_list-based):
    - Read directly from  PhysionNetCLSProcessor processed_data/PTdict_list.npy and processed_data/arr_outcomes.npy
    """
    ...
    def __init__(self, *args, split_idx: int = 5, **kwargs):
        super().__init__("physionet", *args, **kwargs)

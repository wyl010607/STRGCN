...
class IrrMaskingForecastTrainer(AbstractTrainer):
    """
    ...
    def train_one_epoch(self, data_loader):
        ...
        for batch_dict in tqmd_:
            ...
            target_forecast_placeholder = torch.zeros_like(
            ...
            with autocast(enabled=self.enable_autocast):
                ...
                loss = self.loss_func(
                    prediction,
                    batch_dict["target_forecast_data"],
                    mask=batch_dict["target_forecast_mask"],
                )
